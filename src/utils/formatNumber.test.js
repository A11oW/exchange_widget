...
describe('Util formatNumber', () => {
  it('Valid value', () => {
    ...
    expect(formatNumber('458723043569383204234364')).toBe(
      '458723043569383204234364'
    );
  ...
  it('Valid prestine', () => {
    ...
    expect(formatNumber(1.1234567890123456789, 10)).toBe('1.1234567890');
    expect(formatNumber('34565345656345345.345657234234', 12)).toBe(
      '34565345656345345.345657234234'
    );
    expect(() => {
